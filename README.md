> This HuWeihuang theme created by [TsangSi](http://tsangsi.github.io/) modified from the original Porter [YuHsuan](https://github.com/YenYuHsuan/hexo-theme-beantech)
> 
> This theme has been published to the [hexo theme list](https://hexo.io/themes/).

# Live Demo

Tsang Si Blog : [http://tsangsi.github.io](http://tsangsi.github.io/)
...
```bash
git clone https://github.com/tsangsi/hexo-theme-tsangsi.git ./hexo-tsangsi
cd hexo-tsangsi
npm install
```
